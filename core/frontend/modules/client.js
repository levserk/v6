define(['game_manager', 'invite_manager', 'user_list', 'socket', 'views_manager',
        'chat_manager', 'history_manager', 'rating_manager', 'sound_manager', 'admin_manager',
        'localization_manager','options', 'EE', 'idleTimer'],
